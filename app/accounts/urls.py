...
from .views import RegisterRequestView  # 회원가입 이메일 전송을 위한 뷰
from .views import RegistrationConfirmView  # 이메일 링크를 통한 회원가입 완료 뷰
from .views import UserView

# URL 패턴 정의
urlpatterns = [
    path(
        "register/", RegisterRequestView.as_view(), name="register-request"
    ),  # 회원가입 요청 (이메일 전송)
    path(
