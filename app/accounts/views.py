...
class RegisterRequestView(APIView):
    def post(self, request):
        ...
        registration_url = request.build_absolute_uri(reverse("registration-confirm") + f"?token={token}")
    ...
    def get(self, request):
        ...
        try:
            ...
            if not user:
                ...
                serializer = UserSerializer(data={"email": email, "password": "defaultpassword"})
            ...
            return Response({"detail": "회원가입이 완료되었습니다."}, status=status.HTTP_200_OK)
